\documentclass[9pt,twocolumn,twoside,$if(lineno)$$lineno$$endif$,printwatermark=$if(watermark)$$watermark$$else$false$endif$]{pinp}
...
\doi{\url{http://cran.r-project.org/package=$package$}}
